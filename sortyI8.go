...
// parent range. Users of pivotI8() must ensure l+5 < h < len(ar)
func pivotI8(ar []int64, l, h int) (int, int64, int) {
	m := mid(l, h)
...
func partitionI8(ar []int64, l, h int) int {
	l, pv, h := pivotI8(ar, l, h)
	for {
