...
// parent range. Users of pivotF8() must ensure l+5 < h < len(ar)
func pivotF8(ar []float64, l, h int) (int, float64, int) {
	m := mid(l, h)
...
func partitionF8(ar []float64, l, h int) int {
	l, pv, h := pivotF8(ar, l, h)
	for {
